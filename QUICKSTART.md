...
git commit -m "Install codex-claude-handoff v3.7.0"
```
...
```powershell
$setup = Join-Path $env:TEMP "codex-claude-handoff-setup.ps1"; Invoke-WebRequest "https://raw.githubusercontent.com/siglernir-ai/codex-claude-handoff/v3.7.0/bootstrap.ps1" -OutFile $setup; powershell.exe -NoProfile -ExecutionPolicy Bypass -File $setup
```
...
```powershell
git clone --branch v3.7.0 --single-branch https://github.com/siglernir-ai/codex-claude-handoff.git C:\Tools\codex-claude-handoff
...
v3.7.0 packages a self-contained public beta Skill. From a clean Git project, run:
