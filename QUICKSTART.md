...
git commit -m "Install codex-claude-handoff v3.4.3"
```
...
```powershell
git clone --branch v3.4.3 --single-branch https://github.com/siglernir-ai/codex-claude-handoff.git C:\Tools\codex-claude-handoff
...
v3.4.3 packages a self-contained public beta Skill. From a clean Git project, run:
