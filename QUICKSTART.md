...
git commit -m "Install codex-claude-handoff v3.4.2"
```
...
```powershell
git clone --branch v3.4.2 --single-branch https://github.com/siglernir-ai/codex-claude-handoff.git C:\Tools\codex-claude-handoff
...
v3.4.2 packages a self-contained public beta Skill. From a clean Git project, run:
