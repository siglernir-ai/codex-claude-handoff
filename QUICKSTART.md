...
git commit -m "Install codex-claude-handoff v3.4.0"
```
...
```powershell
git clone --branch v3.4.0 --single-branch https://github.com/siglernir-ai/codex-claude-handoff.git C:\Tools\codex-claude-handoff
...
v3.4.0 packages a self-contained public beta Skill. From a clean Git project, run:
