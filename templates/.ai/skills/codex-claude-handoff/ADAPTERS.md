...
deferred to v1.4.0. Master/Codex remains `callable: no` (the v1.3.1 Master work is a
capture-only POC, not an applied Master turn - see "Codex Master Capture POC" below).
